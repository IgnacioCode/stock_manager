...
export default function Sidebar() {
  ...
  return (
    <div className={`flex h-max min-h-screen`}>
      {/* Sidebar */}
      <div
        className={`${isOpen ? 'w-[8vw]' : 'w-[4vw]'} bg-white h-max min-h-screen pt-2 shadow-md transition-all duration-300 ease-in-out flex flex-col items-center`}
      >
        <button
        ...
        <nav className="mt-5 w-full">
          <ul className="flex flex-col items-center w-full">
            <li className="mb-4 w-full">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-[1.3vw] w-[1.3vw]">
